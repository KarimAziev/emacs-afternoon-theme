...
(let* ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   'afternoon
   `(default ((,class (:background ,background :foreground ,foreground :height 100))))
   ...
   ;; ivy
   `(ivy-highlight-face ((,class (:foreground "goldenrod" :background unspecified))))
   `(ivy-minibuffer-match-highlight ((,class (:weight bold :background unspecified))))
   `(ivy-yanked-word ((,class (:foreground ,yellow :background unspecified))))
   ;; ivy-cursor
   ;; IDO
   ...
   `(mode-line ((t (:background "black" :box nil :weight bold :family "Lucida Grande"))))
   `(mode-line-highlight ((,class (:foreground "purple1" :box nil))))
   `(mode-line-inactive ((,class (:inherit mode-line :background "gray7" :foreground "dark gray" :box nil :weight bold))))
   `(mode-line-emphasis ((,class (:foreground ,foreground :slant italic))))
   `(minibuffer-prompt ((,class (:foreground ,blue))))
   `(region ((,class (:background ,selection ::foreground "gold"))))
   ...
   `(eldoc-highlight-function-argument ((,class (:foreground "#ffffd7d70000" :weight bold))))
   ;; macrostep
   ...
   ;; dired+
   `(diredfl-dir-name ((,class (:background "#2C2C2C2C2C2C" :foreground "lawn green"))))
   ...
   `(magit-item-highlight ((,class (:inherit highlight :background "#0000fafa9a9a"))))
   ...
   `(highlight ((,class (:inverse-video t :background ,current-line))))
   `(hl-line ((,class (:extend t :weight bold))))
   ...
   `(custom-button ((,class (:box (:line-width 1 :foreground "khaki1")
                                  :background "#000000" :foreground "khaki1"))))
   `(custom-button-pressed ((,class (:box (:line-width 1 :foreground "d3d3d3d3d3d3")
                                          :background "#000000" :foreground "#d3d3d3d3d3d3"))))
   `(custom-button-mouse ((,class (:box (:line-width 1 :foreground "d3d3d3d3d3d3")
                                        :background "#0a0a0a0a0a0a" :foreground "#d3d3d3d3d3d3"))))
   `(custom-button-unraised ((,class (:background "#0a0a0a0a0a0a" :foreground "white"))))
   ...
   `(aw-leading-char-face ((,class (:foreground "magenta" :box (:line-width 2 :color "magenta" :style pressed-button))))))
