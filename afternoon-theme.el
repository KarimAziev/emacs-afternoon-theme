...
(let* ((class '((class color)
  ...
  (custom-theme-set-faces
   ...
   `(paren-face-match ((,class (:foreground unspecified
                                            :background unspecified
                                            :inherit show-paren-match))))
   `(paren-face-mismatch ((,class (:foreground unspecified
                                               :background unspecified
                                               :inherit show-paren-mismatch))))
   `(paren-face-no-match ((,class (:foreground unspecified
                                               :background unspecified
                                               :inherit show-paren-mismatch))))
   ...
   ;; nxml
   `(nxml-name-face ((,class (:foreground unspecified
   ...
   `(ledger-font-occur-narrowed-face ((,class (:inherit font-lock-comment-face
                                                        :invisible t))))
