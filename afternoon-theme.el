...
(let* ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   ;; ivy
   `(ivy-highlight-face ((,class (:foreground "goldenrod" :background nil))))
   `(ivy-minibuffer-match-highlight ((,class (:weight bold :background nil))))
   `(ivy-yanked-word ((,class (:foreground ,yellow :background nil))))
   ;; ivy-cursor
   ;; IDO
